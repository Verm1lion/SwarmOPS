    ...
    return (
        <aside className="hidden md:flex w-20 flex-col items-center border-r border-gray-200 bg-charcoal py-8 transition-all duration-300 ease-in-out z-20 shadow-xl fixed h-full left-0 top-0">
            ...
            <div className="mt-auto flex flex-col items-center gap-6">
                <Link href="#" className="group relative flex h-12 w-12 items-center justify-center rounded-xl text-gray-400 transition-all hover:bg-white/10 hover:text-white">
                    <span className="material-symbols-outlined text-[24px]">settings</span>
                    <span className="absolute left-14 hidden rounded-md bg-gray-900 px-2 py-1 text-xs text-white opacity-0 transition-opacity group-hover:block group-hover:opacity-100 z-50 whitespace-nowrap">Settings</span>
                </Link>
